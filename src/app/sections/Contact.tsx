  ...
  return (
    <section id="contact" className="w-full">
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        {/* Mesaj Formu */}
        <div className="bg-gradient-to-br from-white via-purple-50 to-blue-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 rounded-3xl shadow-2xl p-12 animate-fade-in-up border border-gray-100 dark:border-gray-700">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-4">
              Mesaj Gönderin
            </h3>
